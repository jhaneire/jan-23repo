...
.wrapper1 .sidebar ul li a .fas{
  width: 25px;
}
.wrapper1 .sidebar ul li:hover{
  background-color: #ffffff;
}   
.wrapper1 .sidebar ul li:hover a{
  color: rgb(15, 15, 15);
}
...
<div class="wrapper1">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="Crud.php"><i class="fas fa-table "></i>Data Table</a></li>
        </ul> 
    </div>
    <div class="main_content">
    <div class="main_content">  
  <div class="container-fluid">
    <h2 class= text-center>Integrative Programming & Technologies</h2>
    <h4 class="datatable design text-center">Lab Collection Project</h4>
    <div class="row">
      <div class="container">
        <div class="btnAdd">
         <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal"   class="btn btn-success btn-sm" >Add User</a>
          <a href="export.php" class="btn btn-success btn-sm"><i class="fa fa-file-excel-o"></i> Export</a>
           <script>
    function Export(){
        var conf = confirm("Please proceed if you wish to continue in exporting the record into excel file.")
        if(conf ==true){
